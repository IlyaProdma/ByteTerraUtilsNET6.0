...
{
    internal class NonStandardMonitorProtocol
    {
        ...
        [JsonPropertyName("heterogenity_left")]
        [JsonInclude]
        public string HeterogenityLeft { get; set; }

        [JsonPropertyName("heterogenity_right")]
        [JsonInclude]
        public string HeterogenityRight { get; set; }

        public NonStandardMonitorProtocol(Session session, Ion ion)
        {
            ...
            Thickness = ion.DegradDepth.ToString();
            ...
            HeterogenityLeft = session.HeterogeneityLeft.ToString();
            HeterogenityRight = session.HeterogeneityRight.ToString();
